...
class _DialPadState extends State<DialPad> with TickerProviderStateMixin {
  ...
  void _loadLastCalledNumber() async {
    ...
    setState(() {
      _lastNumberCalledIsSet =
          prefs.getString('lastCalledNumber') != null ? true : false;
    });
  }
        ...
        child: Column(
          ...
          children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            if (dialedNumber == '' &&
                                _fromTransferScreen &&
                                _fusionConnection!
                                    .settings!.myCellPhoneNumber!.isNotEmpty)
                              SizedBox(
                                height: 40,
            ...
            Row(
              ...
              children: [
                AnimatedOpacity(
                    opacity: (_lastNumberCalledIsSet || dialedNumber != "")
                        ? 1.0
                        : 0.5,
                    curve: Curves.easeIn,
