...
class DialPadModal extends StatefulWidget {
  ...
  DialPadModal(this._fusionConnection, this._softphone,
      {Key? key, this.initialTab, this.numberToDial})
      : super(key: key);
...
class _DialPadModalState extends State<DialPadModal>
  ...
  String? get _numberToDial => widget.numberToDial;
  TabController? _tc;
  int? _initialIndex = 1;
  int? _tabIndex = 1;
  String _query = "";
  ...
  void initState() {
    ...
    if (widget.initialTab != null) _initialIndex = widget.initialTab;
              ...
              child: Column(children: [
                DecoratedBox(
                  decoration: BoxDecoration(
                      border:
                          Border(bottom: BorderSide(width: 1.5, color: ash))),
                  child: TabBar(
                ...
                DialPad(_fusionConnection, _softphone,
                    numberToDial: _numberToDial, onQueryChange: (String s) {
                  setState(() {
                    _query = s;
                  });
                })
            ...
            BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(
                  icon: Image.asset(
                      "assets/icons/call_view/toolbar/park_inactive.png",
                      width: 13.6,
                      height: 20),
                  activeIcon: Image.asset(
                      "assets/icons/call_view/toolbar/park_active.png",
                      width: 13.6,
                      height: 20),
                  label: "Parked Calls",
                ),
                BottomNavigationBarItem(
                    icon: Image.asset(
                        "assets/icons/call_view/toolbar/dialpad_inactive.png",
                        width: 17.45,
                        height: 20),
                    activeIcon: Image.asset(
                        "assets/icons/call_view/toolbar/dialpad_active.png",
                        width: 17.45,
                        height: 20),
                    label: 'Dial Pad'),
                BottomNavigationBarItem(
                    icon: Image.asset(
                        "assets/icons/call_view/toolbar/voicemail_inactive.png",
                        width: 22,
                        height: 20),
                    activeIcon: Image.asset(
                        "assets/icons/call_view/toolbar/voicemail_active.png",
                        width: 22,
                        height: 20),
                    label: 'Voicemails')
              ],
          ...
          child: Row(
              ...
              children: [
                ContactCircle.withDiameterAndMargin(
                    info.contacts, info.crmContacts, 64, 8),
                Expanded(
                    child: Column(
                      ...
                      if (!(info.getCompany(defaul: "")!.trim() != ""))
                        Text(" ",
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.w700,
                                fontSize: 14)),
                      Text(info.getName(defaul: "Unknown")!,
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 21,
                              fontWeight: FontWeight.w900)),
                      Text(info.phoneNumber!.formatPhone(),
                          style: TextStyle(
                              color: translucentWhite(0.66),
                              fontSize: 12,
                              fontWeight: FontWeight.w700))
                    ])),
                Text(_softphone.getCallRunTimeString(_activeCall!),
                    style: TextStyle(
                        height: 1.0,
                        color: Colors.white,
                        fontSize: 21,
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Container(
            ...
            child: Column(children: [
              Container(height: 60),
              if (_tabIndex == 0 && _activeCall != null) _callView(),
              Expanded(
                  child: Container(
                      decoration: BoxDecoration(
                          color: particle,
